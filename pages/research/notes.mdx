...
# GG17/GG18 critcisms of Gitcoin
...
# Anonymized Feedback from insiders.
...
## Leadership problems: 
- Current leaders are a great people person/ops persons but lacks vision + community foresight + has a hard time rallying the troops. 
...
## anything else you think would have helpful?

Hearing familiar voices from Gitcoin's history, like you/Scott Moore etc. all come together with those from the new Gitcoin and have a plan that people can agree on would be valuable. I guess that depends on if it current leadership is going to stick around or what happens, but either way a written thing and maybe even a short video describing: 1) What Gitcoin was, 2) What Gitcoin is now, 3) Mission, 4) What to expect next
...
TODO: insert lihnk to Kain greenpill ep
...
i think people are more likely to pile on when it's socially acceptable/encouraged (and fuels engagement for the individual accounts). and the Gitcoin public perception, for a number of reasons, has been declining over the past year. 

the transition from company to DAO, hosted to onchain protocol. missteps like blueDAO, shell, challenges with infra changes, on chain gas costs, (what feels like) arbitrary grant approvals have all played a part.

feels like the org has broadened its purview quite a bit over the years, leading to some loss of effectiveness, and some loss of legitimacy

paired with the culture of calling out scams, grassroots defense against abusive institutions - sometimes people feel a righteous obligation to tap into that
reordered the parts
