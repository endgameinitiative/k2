...
Endgame is a plan to make Gitcoin successful by (1st) tuning product market fit, (2nd) get it financially thriving, and (3rd) eventually ossifying the project.

## Endgame in one paragraph

Gitcoin is a flywheel of four different products under the same umbrella.  Endgame is a plan to help Gitcoin tune it's product market fit and financially thrive, and thereby achieve it's north stars: to fund the worlds public goods + create a more democratic web.  Eventually, Gitcoin will ossify into a very simple core with complexity at the edges - products will break into subDAOs where matters related to each individual protocol can be managed.
