...
Endgame is a plan to tune Gitcoin's product market fit, get it financially thriving, and then eventually ossify the project.

## Endgame in one paragraph

Gitcoin is a flywheel of a couple of different products under the same umbrella.  Endgame is a plan to help Gitcoin tune it's product market fit and financially thrive, and thereby achieve it's north stars: to fund the worlds public goods + create a sybil resistent economy.  Eventually, Gitcoin will ossify into a very simple core, but it's product teams may break into subDAOs where they can manage matters related to their own individual protocol.
