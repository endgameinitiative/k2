...
Gitcoin has had $50m worth of impact so far (https://impact.gitcoin.co).  This document envisions 100x impact growth over the coming decade, and charts a course towards it.

Success is not guaranteed.  But if we coordinate to set up [the right flywheel] + breathe momentum into it, with a little luck and skill, wagmi.
