...
## Gitcoin offers the following solutions:
...
1. Any EVM-based ecosystem that wants to build value for their community by funding what matters, can use Grants Stack to do it.
