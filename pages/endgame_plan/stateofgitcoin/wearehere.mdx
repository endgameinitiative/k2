...
Gitcoin offers a suite of products under one economic umbrella. Each product solves a problem for end users and also for other products in the network.  The core of each product is trustware (mechanisms that create assurances through technology, as opposed to through social coordination).
