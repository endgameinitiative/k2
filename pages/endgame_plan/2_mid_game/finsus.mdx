...
We are not sure whether (1) taking in proceeds from revenue or (2) GTC Staking is the best model for Gitcoin.

One thing we've discussed is having a barbell strategy.  You can either pay $$$ to use the products (left barbell) or you can stake gtc (right barbell) + become a stakeholder in the ecosystem.
