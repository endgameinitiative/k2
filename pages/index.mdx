** Warning This documentation describes planned functionality and processes that has not yet been implemented. Be aware that parts may be inaccurate or out of date. ***

# Introduction
 
This is endgame initiative.
...
It is also a homage to [Makers endgame](https://endgame.makerdao.com/endgame/overview), an articulation of the final state of MakerDAO:
