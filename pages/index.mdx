...
3. **Propose** - You can propose your own strategic thinking, either [by forking this repo](https://github.com/endgameinitiative/k2/tree/main) or in any format you choose.
...
1. [Kevin/Kyle endgame](https://k2.endgame.work/endgame_plan/tldr)
2. whomever is interested is welcome to write one to the extent that their view differs from any of the forks.
3. if CSDO is interested, they can maintain a CSDO fork of this repo or some other type of vision doc.
